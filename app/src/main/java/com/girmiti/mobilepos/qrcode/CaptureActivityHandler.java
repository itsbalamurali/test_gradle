...
public final class CaptureActivityHandler extends Handler {
    ...
    CaptureActivityHandler(CaptureActivity activity, ArrayList<BarcodeFormat> decodeFormats,
                           String characterSet) {
    ...
    public void handleMessage(Message message) {
        switch (message.what) {
            ...
            case R.id.zxinglib_decode_failed:
                state = State.PREVIEW;
                CameraManager.get().requestPreviewFrame(decodeThread.getHandler(), R.id.zxinglib_decode);
                break;
