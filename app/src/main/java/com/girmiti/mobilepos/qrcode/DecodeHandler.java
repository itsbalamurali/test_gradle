...
import com.girmiti.mobilepos.qrcode.camera.PlanarYUVLuminanceSource;
...
final class DecodeHandler extends Handler {
  ...
  DecodeHandler(CaptureActivity activity, HashMap<DecodeHintType, Object> hints) {
  ...
  private void decode(byte[] data, int width, int height) {
    ...
    try {
      ...
      logger.severe( "ReaderException"+ re);
      // continue
    } finally {
