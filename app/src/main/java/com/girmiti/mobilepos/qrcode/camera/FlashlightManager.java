...
final class FlashlightManager {
  ...
  private static Logger logger = Logger.getNewLogger("com.girmiti.mobilepos.qrcode.camera");
  private static final String MESSAGE = "Unexpected error while invoking";
  ...
  private static Object invoke(Method method, Object instance, Object... args) {
    try {
      ...
      Log.w(TAG, MESSAGE + method, e);
      return null;
    } catch (InvocationTargetException e) {
      logger.severe( "InvocationTargetException"+e );
      return null;
    } catch (RuntimeException re) {
      Log.w(TAG, MESSAGE + method, re);
      return null;
    }
  }
